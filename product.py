...
class productClass:
    def __init__(self,root):
        ...
        #------------ title --------------
        title=Label(product_Frame,text="Manage Product Details",font=("goudy old style",18),bg="#607d8b",fg="white").pack(side=TOP,fill=X)
        ...
        #-------------- buttons -----------------
        btn_add=Button(product_Frame,text="Save",command=self.add,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=10,y=400,width=100,height=40)
        btn_update=Button(product_Frame,text="Update",command=self.update,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=120,y=400,width=100,height=40)
        btn_delete=Button(product_Frame,text="Delete",command=self.delete,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=230,y=400,width=100,height=40)
        ...
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=410,y=9,width=150,height=30)
