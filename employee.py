...
class employeeClass:
    def __init__(self,root):
        ...
        btn_search=Button(SearchFrame,command=self.search,text="Search",font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=410,y=9,width=150,height=30)

        #-------------- title ---------------
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#607d8b",fg="white").place(x=50,y=100,width=1000)
        ...
        #-------------- buttons -----------------
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=500,y=305,width=110,height=28)
        ...
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=740,y=305,width=110,height=28)
