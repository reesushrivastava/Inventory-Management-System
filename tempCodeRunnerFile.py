...
class IMS:
    def __init__(self,root):
        ...
        #------------ logout button -----------
        btn_logout=Button(self.root,text="HOME",font=("times new roman",15,"bold"),bg="#607d8b",cursor="hand2").place(x=1150,y=10,height=50,width=150)
        ...
        lbl_menu=Label(LeftMenu,text="Menu",font=("times new roman",20),bg="#607d8b").pack(side=TOP,fill=X)
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
